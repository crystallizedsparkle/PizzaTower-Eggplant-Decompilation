...
if (sprite_index != scaredspr && x != targetplayer.x && state != UnknownEnum.Value_129 && bombreset <= 0 && grounded && targetplayer.state != UnknownEnum.Value_16 && targetplayer.state != UnknownEnum.Value_17)
{
