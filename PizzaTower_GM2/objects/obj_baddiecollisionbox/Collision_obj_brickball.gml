...
if (instance_exists(baddieID) && baddieID.invtime == 0 && baddieID.rattime <= 0 && baddieID.state != UnknownEnum.Value_4 && baddieID.state != UnknownEnum.Value_137 && !baddieID.invincible && baddieID.instantkillable)
{
    scr_soundeffect(46);
